...
const ru = {
  ...
  section: {
    enable: 'Построить сечение',
    disable: 'Завершить редактирование',
    clear: 'Очистить сечение',
    point: 'Точка',
    ...
    hints: {
      inactive: 'Сечение сохранено. Включите режим, чтобы изменить точки.',
      needPoints: 'Выберите не менее трёх точек на фигуре.',
      coincident: 'Точки совпадают. Переместите или удалите одну из них.',
      collinear: 'Точки лежат на одной прямой. Выберите другую точку.',
      empty: 'Плоскость не пересекает фигуру.',
      ready: 'Сечение построено.',
      approximate: 'Для криволинейной фигуры сечение приближённое.',
      unsupported: 'Сечения сферы пока не поддерживаются.',
    },
    appearance: {
      color: 'Цвет сечения',
